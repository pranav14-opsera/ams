...
import { HardCapEnforcementModule } from "../hard-cap/hard-cap-enforcement.module";
...
@Module({
  imports: [ScheduleModule.forRoot(), CreditsModule, AlertsModule, CreditThresholdAlertsModule, HardCapEnforcementModule],
