...
// duplicate one declared here too. AuditRetentionModule (WO-049) is
// imported so AuditReconciliationService can check cold_storage_manifest
// — a reconciliation period overlapping an already-tiered partition must
// not flag that data as a gap.
@Module({
  imports: [AuditEventsModule, AuditRetentionModule],
